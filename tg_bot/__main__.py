...
I'm a group manager bot maintained by [Ali Hasan](tg://user?id={}). I'm built in python3, using the \
python-telegram-bot library, and am fully opensource - you can find what makes me tick \
[here](github.com/AliHasan96/tgbot)!
...
It took lots of work for [my maintainer](t.me/AliHasan96) to get me to where I am now, and every donation helps \
...
Please contact [my maintainer](t.me/AliHasan96) if you want to donate."""
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hi there!")
